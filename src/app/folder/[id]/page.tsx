  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Folder view — raw/ and edited/ as sub-folders */}
        {view === 'folders' && (
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    {editedImages.length} image{editedImages.length !== 1 ? 's' : ''}
                  </p>
                  <p className="text-xs text-gray-400 mt-1">Background-replaced outputs</p>
                </div>
              </button>
            </div>
          </>
